...
from lambdawalker.draw.color.HSLuvColor import HSLuvColor, random_alpha
from lambdawalker.draw.shapes.draw_blured_image_contour import draw_contour
from lambdawalker.draw.svg.svg_to_png import svg_to_png
from lambdawalker.random.selection.select_random_file import select_random_file


def draw_random_country_blured_contour(img: Image.Image, primary_color: HSLuvColor):
    source = resources.files("lambdawalker").joinpath("assets/img/country_shapes")
